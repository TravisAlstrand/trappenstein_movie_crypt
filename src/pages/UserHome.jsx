      ...
      <section className="flex flex-col items-center justify-center px-4 py-20 text-center md:py-24">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="max-w-2xl text-lg text-gray-300 md:text-xl">
            Your personal horror movie sanctuary. Explore, review, and curate
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            to="/user/settings"
            className="rounded-lg border-2 border-neutral-600 bg-neutral-800/50 px-8 py-3 font-semibold backdrop-blur-sm transition-all hover:scale-105 hover:border-neutral-500 hover:bg-neutral-700/50"
          >
            Account Settings
          </Link>
        </div>
      ...
      <section className="px-4 py-16">
        <div className="mx-auto max-w-4xl rounded-2xl border-2 border-neutral-700 bg-linear-to-br from-neutral-900 to-neutral-800 p-8 text-center shadow-2xl md:p-12">
          ...
          <p className="mb-8 text-lg text-gray-300">
            Dive into the world of horror cinema and start building your
            collection today.
          </p>
          <Link
            to="/movies/search"
